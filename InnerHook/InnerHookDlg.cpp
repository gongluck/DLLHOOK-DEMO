...
static HHOOK g_hmouse = nullptr;
static HHOOK g_hkey = nullptr;
...
BOOL CInnerHookDlg::OnInitDialog()
{
	...
	// TODO: 在此添加额外的初始化代码
	g_hmouse = SetWindowsHookEx(WH_MOUSE, MouseProc, nullptr, GetCurrentThreadId());
	g_hkey = SetWindowsHookEx(WH_KEYBOARD, KeyboardProc, nullptr, GetCurrentThreadId());
